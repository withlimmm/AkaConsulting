                        ...
                        @foreach($footerAdmins as $adm)
                            ...
                            <a href="https://wa.me/{{ $admPhone }}?text={{ urlencode(__($waText)) }}"
                               ...
                               class="flex items-center gap-3 px-4 py-2.5 rounded-xl bg-green-500/10 border border-green-500/20 hover:bg-green-500/20 transition-all group w-fit">
                                ...
                                <span class="text-sm text-green-400 font-semibold group-hover:text-green-300">{{ $adm['name'] ?? 'Admin' }} — {{ $adm['phone'] ?? '' }}</span>
                            </a>
                        @endforeach
                    @endif
                </div>
            ...
            <div class="p-6 bg-slate-950/30">
                ...
                <div class="mt-6 flex flex-col items-center gap-3">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        ...
                        @endphp
                        @if($mainPhone)
                        <a href="https://wa.me/{{ $mainPhone }}" target="_blank" class="flex items-center justify-center gap-2 py-2.5 bg-slate-900/50 border border-white/5 rounded-lg text-[11px] font-bold text-slate-300 hover:border-emerald-500 hover:text-emerald-400 transition-all shadow-sm">
