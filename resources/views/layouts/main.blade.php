        ...
        <div class="border-t border-white/5">
            <div class="mx-auto max-w-7xl px-4 md:px-8 lg:px-20 py-5 flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <span class="w-px h-3 bg-white/10"></span>
                    <a href="https://www.instagram.com/akaconsulting" target="_blank" rel="noopener noreferrer"
            ...
            <div class="p-6 bg-slate-50/20">
                ...
                <div class="mt-6 flex flex-col gap-3" x-data="{ showAdmins: false }">
                    ...
                    <button @click="showAdmins = !showAdmins"
                        ...
                        <img src="https://cdn-icons-png.flaticon.com/512/124/124034.png" class="w-4 h-4 brightness-0 invert" alt="WA">
                        Chat WhatsApp
                    ...
                    <a href="https://www.instagram.com/akaconsulting" target="_blank" rel="noopener noreferrer"
                       class="flex items-center justify-center gap-2 py-2.5 bg-white border border-slate-100 rounded-xl text-[11px] font-bold text-slate-600 hover:border-primary hover:text-primary transition-all shadow-sm">
