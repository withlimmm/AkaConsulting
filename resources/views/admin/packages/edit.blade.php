...
@section('title', 'Edit Paket - AKA Consulting CMS')
@section('page_title', 'Edit Paket')
@section('page_subtitle', 'Perbarui detail paket layanan dan harga.')
    ...
    <form action="{{ route('admin.packages.update', $package) }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="category" list="category_list" value="{{ old('category', $package->category) }}" placeholder="Contoh: Pendirian Badan Usaha" required
            ...
            <div>
                ...
                <input type="text" name="price" value="{{ old('price', $package->price) }}" placeholder="Contoh: Rp 1.500.000 / Bulan" required
                    class="w-full rounded-xl border border-outline-variant/50 px-4 py-2.5 focus:border-primary focus:ring-2 focus:ring-primary/20">
        ...
        <div>
            ...
            <textarea name="description" rows="2"
                class="w-full rounded-xl border border-outline-variant/50 px-4 py-2.5 focus:border-primary focus:ring-2 focus:ring-primary/20">{{ old('description', $package->description) }}</textarea>
        ...
        <div>
            ...
            <textarea name="features" rows="5" placeholder="Fitur 1&#10;Fitur 2&#10;Fitur 3"
                class="w-full rounded-xl border border-outline-variant/50 px-4 py-2.5 focus:border-primary focus:ring-2 focus:ring-primary/20">{{ old('features', $package->features_text) }}</textarea>
